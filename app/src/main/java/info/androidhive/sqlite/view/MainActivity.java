...
public class MainActivity extends AppCompatActivity {
   ...
   /**
    * Shows alert dialog with EditText options to enter / edit a note. when shouldUpdate=true, it
    * automatically displays old note and changes the button text to UPDATE
    */
                 ...
                 .setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                       ...
                       if (shouldUpdate && note != null) {
                          ...
                          updateNote(inputNote.getText()
                                              .toString(), position);
                       } else {
                          // create new note
                          createNote(inputNote.getText()
                                              .toString());
                       }
                    }
                 });
